...
WINDOW_ICONS = {
    ...
    'jetbrains-studio': fa.icons['android'],
    ...
    'floating_term' : fa.icons['terminal'],
    'gucharmap' : fa.icons['icons'],
    'sayonara' : fa.icons['music'],
    'pcmanfm' : fa.icons['folder'],
    'filelight' : fa.icons['folder']
}

# This icon is used for any application not in the list above
DEFAULT_ICON = fa.icons['terminal']
