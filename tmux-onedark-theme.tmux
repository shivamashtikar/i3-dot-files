...
set "message-style" "bg=$onedark_green,fg=$onedark_black"
...
use_dir=$(tmux show-option -gqv "@use-directory")
if [ "$use_dir" = "true" ];
then
  set "window-status-format" "#[fg=$onedark_black,bg=$onedark_black,nobold,nounderscore,noitalics]#[fg=$onedark_white,bg=$onedark_black] #I  #(basename #{pane_current_path}) #[fg=$onedark_black,bg=$onedark_black,nobold,nounderscore,noitalics]"
  set "window-status-current-format" "#[fg=$onedark_black,bg=$onedark_visual_grey,nobold,nounderscore,noitalics]#[fg=$onedark_white,bg=$onedark_visual_grey,nobold] #I  #(basename #{pane_current_path})  #[fg=$onedark_visual_grey,bg=$onedark_black,nobold,nounderscore,noitalics]"
else
